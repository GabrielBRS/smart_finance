...
O que este pedaço do engine precisa fazer.
...
Usar **Mojo 1.0+ estável** e APIs verificadas na documentação oficial ou na versão instalada. Não usar sintaxe/API de tutorial antigo. Recursos nightly/experimentais/MAX instáveis devem ser marcados explicitamente e justificados.
