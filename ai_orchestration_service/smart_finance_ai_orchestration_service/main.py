...
from cognition.adapters import TritonLLM, TritonEmbedder
from cognition.agent import CognitionAgent
from cognition.config import LLM_BASE_URL, LLM_MODEL, EMBED_MODEL
from cognition.multi_agent import build_multi_agent
from cognition.repositories import PostgresRepository
from cognition.retrieval import run_langchain, build_graph
from cognition.schemas import ChatRequest, ChatResponse
from cognition.vectorstores import MilvusVectorStore
...
async def lifespan(app: FastAPI):
    ...
    try:
        from cognition.crewai import configure
...
async def chat_crew(req: ChatRequest, request: Request):
    ...
    from cognition.crewai import run_crew
